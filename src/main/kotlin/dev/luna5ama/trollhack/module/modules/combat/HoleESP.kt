...
internal object HoleESP : Module(
    ...
    private val fourBlocksHole0 = setting("4 Blocks Hole", false)
    ...
    private val bedrockColor by setting("Bedrock Color", ColorRGB(255, 255, 255), false)
    private val obbyColor by setting("Obby Color", ColorRGB(255, 255, 255), false, obbyHole0.atTrue())
    private val twoBlocksColor by setting("2 Blocks Color", ColorRGB(255, 255, 255), false, twoBlocksHole0.atTrue())
    private val fourBlocksColor by setting("4 Blocks Color", ColorRGB(255, 255, 255), false, fourBlocksHole0.atTrue())
    private val trappedColor by setting("Trapped Color", ColorRGB(160, 160, 160), false, trappedHole0.atTrue())
    ...
    private val aFilled by setting("Filled Alpha", 30, 0..255, 1, filled0.atTrue())
    private val aOutline by setting("Outline Alpha", 160, 0..255, 1, outline0.atTrue())
    private val glowHeight by setting("Glow Height", 0.5f, 0.25f..4.0f, 0.25f, renderMode0.atValue(RenderMode.GLOW))
