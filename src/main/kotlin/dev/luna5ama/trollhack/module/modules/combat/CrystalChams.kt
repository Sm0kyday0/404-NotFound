...
internal object CrystalChams : Module(
    ...
    private val filledColor by setting("Filled Color", ColorRGB(255, 255, 255, 60), true, ::filled)
    val outline by setting("Outline", true)
    val outlineDepth by setting("Outline Depth", false, ::outline)
    private val outlineColor by setting("Outline Color", ColorRGB(255, 255, 255, 200), true, ::outline)
