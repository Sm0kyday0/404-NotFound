...
internal object AutoHoleFill : Module(
    ...
    private val targetColor by setting("Target Color", ColorRGB(255, 255, 255), false)
    private val otherColor by setting("Other Color", ColorRGB(255, 255, 255), false)
    private val filledColor by setting("Filled Color", ColorRGB(255, 255, 255), false)
