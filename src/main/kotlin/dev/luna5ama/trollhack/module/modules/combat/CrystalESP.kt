...
internal object CrystalESP : Module(
    ...
    private val r by setting("Red", 255, 0..255, 1)
    private val g by setting("Green", 255, 0..255, 1)
    private val b by setting("Blue", 255, 0..255, 1)
    private val aFilled by setting("Filled Alpha", 50, 0..255, 1, ::filled)
    private val aOutline by setting("Outline Alpha", 130, 0..255, 1, ::outline)
