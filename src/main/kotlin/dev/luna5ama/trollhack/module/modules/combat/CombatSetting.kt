...
internal object CombatSetting : Module(
    ...
    private val renderPrediction =
        setting("Render Prediction", false, page.atValue(Page.RENDER) and motionPredict.atTrue())
    private val chams0 = setting("Chams", false, page.atValue(Page.RENDER))
    val chams by chams0
    private val chamsColor by setting(
        "Chams Color",
        ColorRGB(255, 255, 255, 130),
        true,
