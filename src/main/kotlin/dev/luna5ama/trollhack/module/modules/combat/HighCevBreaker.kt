...
internal object HighCevBreaker : Module(
    name = "HighCev Breaker",
    description = "High Cev :)",
    ...
    private fun SafeClientEvent.calcTarget(): Info? {
        ...
        val pos = BlockPos(target.posX, target.posY + 3.5, target.posZ)
    ...
    private fun SafeClientEvent.wallCheck(pos: BlockPos): Boolean {
        ...
        return eyePos.distanceSqTo(pos.x + 0.5, pos.y + 1.0, pos.z + 0.5) <= 9.0
                || world.rayTraceBlocks(eyePos, pos.toVec3d(0.5, 3.7, 0.5), false, true, false) == null
    }
