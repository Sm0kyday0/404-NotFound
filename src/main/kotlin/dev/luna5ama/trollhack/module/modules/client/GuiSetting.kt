...
internal object GuiSetting : Module(
    ...
    private val primarySetting by setting("Primary Color", ColorRGB(255, 255, 255, 200))
    private val backgroundSetting by setting("Background Color", ColorRGB(0, 0, 0, 160))
